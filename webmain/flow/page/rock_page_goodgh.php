...
$(document).ready(function(){
	{params}
	var modenum = 'goodgh',modename='物品归还',isflow=1,modeid='100',atype = params.atype,pnum=params.pnum,modenames='归还物品';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"custname","name":"\u9886\u7528\u5355","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u9886\u7528\u5355id","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"wupinlist","name":"\u5f52\u8fd8\u7684\u7269\u54c1","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"state","name":"\u5165\u5e93\u72b6\u6001","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_goodgh|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistgoodgh = a;
			addtabs({num:'daorugoodgh',url:'flow,input,daoru,modenum=goodgh',icons:'plus',name:'导入物品归还'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"领用单",dataIndex:"custname"},{text:"说明",dataIndex:"explain"},{text:"归还的物品",dataIndex:"wupinlist"},{text:"入库状态",dataIndex:"state",sortable:true},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewgoodgh_{rand}').bootstable(bootparams);
	c.init();
