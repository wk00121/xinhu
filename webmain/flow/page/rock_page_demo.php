...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"申请日期",dataIndex:"applydt"},{text:"编号",dataIndex:"num"},{text:"客户",dataIndex:"custname"},{text:"省",dataIndex:"sheng"},{text:"市",dataIndex:"shi"},{text:"县(区)",dataIndex:"xian"},{text:"说明",dataIndex:"explain"},{text:"弹出下 拉单选",dataIndex:"tanxuan"},{text:"弹框下 拉多选",dataIndex:"tanxuancheck"},{text:"状态",dataIndex:"statustext"},{
