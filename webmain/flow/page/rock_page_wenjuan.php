...
$(document).ready(function(){
	{params}
	var modenum = 'wenjuan',modename='调查问卷',isflow=0,modeid='101',atype = params.atype,pnum=params.pnum,modenames='问卷项';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"title","name":"\u6807\u9898","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"recename","name":"\u9488\u5bf9\u5bf9\u8c61","fieldstype":"changedeptusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"startdt","name":"\u5f00\u59cb\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"enddt","name":"\u622a\u6b62\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"},{"fields":"temp_total","name":"\u7edf\u8ba1(\u5df2\u63d0\u4ea4\/\u603b\u4eba\u6570)","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_wenjuan|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistwenjuan = a;
			addtabs({num:'daoruwenjuan',url:'flow,input,daoru,modenum=wenjuan',icons:'plus',name:'导入调查问卷'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('d2VuanVhbg::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"标题",dataIndex:"title"},{text:"针对对象",dataIndex:"recename"},{text:"开始日期",dataIndex:"startdt",sortable:true},{text:"截止日期",dataIndex:"enddt"},{text:"统计(已提交/总人数)",dataIndex:"temp_total"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewwenjuan_{rand}').bootstable(bootparams);
	c.init();
