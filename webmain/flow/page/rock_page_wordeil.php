...
$(document).ready(function(){
	{params}
	var modenum = 'wordeil',modename='文件传送',isflow=1,modeid='87',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'文件传送('+nowtabs.name+')',
				cont:'文件传送('+nowtabs.name+')的列表的',
				explain:'订阅[文件传送]的列表',
				objtable:a
			});
		},
...
<div>
	...
	<tr>
		...
		<td style="padding-left:10px"><select class="form-control" style="width:120px" id="selstatus_{rand}"><option value="">-全部状态-</option><option style="color:blue" value="0">待接收</option><option style="color:green" value="1">已接收</option><option style="color:#888888" value="5">已作废</option><option style="color:#17B2B7" value="23">退回</option></select></td>
