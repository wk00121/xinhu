...
$(document).ready(function(){
	{params}
	var modenum = 'scheduld',modename='日程待办',isflow=1,modeid='99',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"title","name":"\u6807\u9898","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"startdt","name":"\u65e5\u7a0b\u65f6\u95f4","fieldstype":"datetime","ispx":"1","isalign":"0","islb":"1"},{"fields":"distren","name":"\u5f85\u529e\u4eba","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"recename","name":"\u63d0\u9192\u7ed9","fieldstype":"changedeptusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_scheduld|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistscheduld = a;
			addtabs({num:'daoruscheduld',url:'flow,input,daoru,modenum=scheduld',icons:'plus',name:'导入日程待办'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('c2NoZWR1bGQ:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"标题",dataIndex:"title"},{text:"日程时间",dataIndex:"startdt",sortable:true},{text:"待办人",dataIndex:"distren"},{text:"提醒给",dataIndex:"recename"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewscheduld_{rand}').bootstable(bootparams);
	c.init();
