...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"合同编号",dataIndex:"num"},{text:"合同分类",dataIndex:"fenlei"},{text:"客户名称",dataIndex:"custname"},{text:"拥有者",dataIndex:"optname",sortable:true},{text:"签约日期",dataIndex:"signdt",sortable:true},{text:"合同金额",dataIndex:"money",sortable:true},{text:"生效日期",dataIndex:"startdt",sortable:true},{text:"截止日期",dataIndex:"enddt",sortable:true},{text:"合同类型",dataIndex:"type"},{text:"待收/付金额",dataIndex:"moneys"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statetext"},{text:"创建人",dataIndex:"createname",sortable:true},{
