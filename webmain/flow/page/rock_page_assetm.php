...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"资产分类",dataIndex:"typeid"},{text:"编号",dataIndex:"num",sortable:true},{text:"名称",dataIndex:"title"},{text:"所在位置",dataIndex:"address"},{text:"状态",dataIndex:"state",sortable:true},{text:"使用者",dataIndex:"usename"},{text:"封面图片",dataIndex:"fengmian"},{
